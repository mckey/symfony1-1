...
function format_daterange(
    ...
    if ($start_date != '' && $end_date != '') {
        return sprintf(
            $full_text,
            format_date($start_date, $format, $culture, $charset),
            format_date($end_date, $format, $culture, $charset)
        );
    } elseif ($start_date != '') {
...
function format_date($date, $format = 'd', $culture = null, $charset = null) : ?string
{
    static $dateFormats = [];
...
function format_datetime($date, $format = 'F', $culture = null, $charset = null) : ?string
{
    return format_date($date, $format, $culture, $charset);
}

function distance_of_time_in_words($from_time, $to_time = null, $include_seconds = false) : string
{
...
function time_ago_in_words($from_time, $include_seconds = false) : string
{
